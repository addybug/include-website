  ...
  app.get('/crash-course/:day', function(req, res) {
    let crashContent = {
      ...
      june16: {
        ...
        description: "<div class='paragraph-container'> <p>Create a program that:</p> </div> <ul> <li>Takes a string as an input</li> <li> If the length of the string is divisible by 2, print the middle 2 characters </li> <ul> <li> Hint: Use this <a href='https://www.freecodecamp.org/news/the-python-modulo-operator-what-does-the-symbol-mean-in-python-solved/#:~:text=The%20%25%20symbol%20in%20Python%20is,basic%20syntax%20is%3A%20a%20%25%20b' class='attachment-links2' > this </a> article. </li> </ul> <li>Else, print the middle character</li> </ul> <h2 class='res_eve_des project-header' > Choose Your Own Adventure </h2> <p> Have you ever played a Choose Your Own Adventure game on your phone or read the Choose Your Own Adventure series? If not, take a minute to look it up and get familiar with the concept because today you will be writing your own! </p> <ul> <li> Print out the beginning of a story. Be as creative as you want! </li> <li>Give the user at least 3 options</li> <li> Print out different results depending on the user’s choice </li> </ul> <p> For this project, write at least 5 different sets of choices for the user. Share your programs in Slack so other students can play! </p>",
        viewAttachments: "unview",
        view2: "unview",
        starter1: "",
        starter2: ""
      ...
      june17: {
        ...
        description: "<div class='paragraph-container'> <p> Download the starter code form the website and create: </p> </div> <ul> <li>A function that returns the domain of the email</li> <li> 3 functions that take the domain of the email address as a parameter and return the new email address with a different domain (<span class='var-style' >to_gmail</span >, <span class='var-style'>to_yahoo</span>, <span class='var-style'>to_outlook</span >) </li> <ul> <li>Hint: Use Use the slides in “Live Lesson 2”</li> </ul> </ul> <h2 class='res_eve_des project-header' > Alphabet Loop </h2> <div class='paragraph-container'> <p> Download the starter code and write a function that: </p> </div> <ul> <li>Takes in a string as a parameter</li> <li>Takes each letter of the string and puts them into a list</li> <div class='list-styling'> <ul> <li> For example, <span class='color2-span'>'cat'</span> to <span style='color:black' >[<span class='color2-span'>'c'</span>, <span class='color2-span'>'a'</span>, <span class='color2-span'>'t'</span>]</span > </li> <li>Hint: Use the slides in “Live Lesson 2”</li> </ul> </div> <li>Loop through all the elements of the list</li> <div class='list-styling'> <ul> <li> Use the <span class='var-style' >get_char_value</span > function in the starter code to get a 0-25 digit number that represents the letter </li> <li> Find the element that corresponds to that index in <span class='var-style' >alphabet_list</span > </li> </ul> </div> <li> Print <span class='black-span' ><span class='color1-span'></span>(<span class='color2-span' >f'{letter} is for {alphabet_list[letter_value]}.'</span ><span class='color3-span'></span>)</span > </li> <div class='list-styling'> <ul> <li>For example, “A is for Apple.”</li> </ul> </ul> </div>",
        viewAttachments: "",
        view2: "",
