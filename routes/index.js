  ...
  app.get('/crash-course/:day', function(req, res) {
    let crashContent = {
      ...
      june19: {
        ...
        description: "<div class='large-margin'> <ul> <li>Download the starter code from the website</li> <li> Find your favorite book on <a href='https://www.gutenberg.org/' class='res_eve_des paragraph-links' >Project Gutenberg</a > and download the .txt file </li> <li> Upload the file in <a href='https://www.repl.it' class='res_eve_des paragraph-links' >repl.it</a > </li> <li> Follow the instructions in the starter code to import the book </li> <li>Put all of the words in the book into a list</li> <li> Remove all of the <span class='var-style' >common_words</span > from the list </li> <div class='small-margin'> <ul> <li>Hint: Convert the word to lowercase before comparing</li> </ul> </div> <li> Create a dictionary and loop through the list to count the frequency of the word </li> <div class='small-margin'> <ul> <li>Assign the word as a key and the value 1</li> </ul> </div> <li> If the word has already been assigned as a key, increment the value by 1 </li> </ul> <li> Run your code to create a word cloud. Save your word cloud until Sunday and we will try to guess what book it is. </li> </ul> </div>",
        viewAttachments: "",
        view2: "unview",
